...
namespace WebApplication1.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "EmployeeID,EmployeeCode,EmailAddress,FirstName,Surname,CellNumber,IsDeleted,DisplayName")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "EmployeeID,EmployeeCode,EmailAddress,FirstName,Surname,CellNumber,IsDeleted,DisplayName")] Employee employee)
        {
            if (ModelState.IsValid)
            {
